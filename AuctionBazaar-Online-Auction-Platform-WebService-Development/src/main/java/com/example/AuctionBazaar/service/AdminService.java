...
public class AdminService {
	...
	public Auction getAuctionById(Long auctionId) {
		return auctionRepository.findById(auctionId).orElseThrow(() -> new NoSuchElementException("Auction not found"));
	}
	...
	public Bid getBidById(Long bidId) {
		return bidRepository.findById(bidId).orElseThrow(() -> new NoSuchElementException("Bid not found"));
	}
